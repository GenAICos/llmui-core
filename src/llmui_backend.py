...
# ============================================================================
# ðŸŒ SYSTÃˆME D'ENRICHISSEMENT DES PROMPTS
# ============================================================================
...
# ============================================================================
# ðŸ” AJOUT AUTHENTIFICATION - SESSION MIDDLEWARE
# ============================================================================
app.add_middleware(
    SessionMiddleware,
...
# ============================================================================
# ðŸ” AUTHENTIFICATION - MODELS & FONCTIONS
# ============================================================================
...
class LLMUICore:
    ...
    async def generate_simple(self, model: str, prompt: str, 
        ...
        try:
            ...
            print(f"ðŸ”„ GÃ©nÃ©ration simple avec {model} (timeout: {timeout_seconds}s, langue: {language})")
    ...
    async def generate_consensus(self, prompt: str, 
        ...
        try:
            ...
            print(f"ðŸ”„ GÃ©nÃ©ration consensus avec {len(worker_models)} workers (timeout: {timeout_seconds}s, langue: {language})")
...
def run_service():
    ...
    print("ðŸš€ Starting LLMUI Backend Service v0.5.0...")
