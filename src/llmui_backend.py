...
#!/usr/bin/env python3
"""
LLMUI Core Backend v0.5.1 - FastAPI Version
==========================================
...
System: LLMUI Core v0.5.1 (Private Server)
...
async def login_user(credentials: LoginRequest, request: Request):
    ...
    try:
        ...
        if user:
            ...
            # CORRECTION v0.5.1: Utiliser verify_password_secure au lieu de SHA256
...
class DatabaseManager:
    ...
    def init_database(self):
        ...
        if cursor.fetchone()[0] == 0:
            # CORRECTION v0.5.1: Utiliser hash_password_secure au lieu de SHA256
...
def run_service():
    ...
    print("🚀 Starting LLMUI Backend Service v0.5.1...")
...
if __name__ == "__main__":
    ...
    if not sys.stdout.isatty():
        ...
        print("""
    ┌─────────────────────────────────────────┐
    │   LLMUI Core Backend v0.5.1 - FastAPI   │
    │   Author: François Chalut               │
    │   Website: https://llmui.org            │
    └─────────────────────────────────────────┘
    ...
    🔐 FIX v0.5.1: Hashage bcrypt/PBKDF2 avec salt
