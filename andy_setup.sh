...
"""
==============================================================================
Andy Setup - Installation interactive LLMUI Core
==============================================================================
"""
...
║       ╚═╝  ╚═╝╚═╝  ╚═══╝╚═════╝    ╚═╝         ╚═══╝   ╚═════╝ ╚══════╝║
║                                                                          ║
║                   Assistant DevOps Autonome v0.5                         ║
...
while true; do
    ...
    case $choice in
        ...
        6)
            ...
            case $log_choice in
                1) less /tmp/andy_install.log ;;
                2) journalctl -u llmui-backend -f ;;
                3) journalctl -u llmui-proxy -f ;;
                4) tail -f /var/log/nginx/llmui-access.log ;;
                5) tail -f /var/log/nginx/llmui-error.log ;;
                6) continue ;;
            esac
            ;;
