...
Now provide ONLY the fixes needed:"""
    ...
    def apply_basic_fixes(self, error_message, requirements_path):
        ...
        try:
            ...
            if python_version.major == 3 and python_version.minor >= 13:
                self.log("🐍 Python 3.13 détecté - mise à jour des packages", "INFO")
    ...
    def run_installation(self):
        ...
        # Installer bcrypt d'abord (dépendance de compilation)
        self.log("📦 Installation de bcrypt (sécurité des mots de passe)...", "INFO")
        self.execute_command(
            "cd /opt/llmui-core && venv/bin/pip install bcrypt",
            "Installation bcrypt",
            5
        )
        ...
        while not pip_success and retry_count < self.max_retries:
            ...
            if success:
                ...
                if retry_count < self.max_retries:
                    ...
                    self.log("❌ Échec après 20 tentatives", "ERROR")
