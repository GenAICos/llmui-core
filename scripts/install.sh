...
# ============================================================================
# LLMUI-CORE - Installation Script (FIXED VERSION)
# ============================================================================
...
setup_directories() {
    ...
    mkdir -p "$INSTALL_DIR"/{logs,data,backups,ssl,sessions,scripts}
    mkdir -p "$INSTALL_DIR"/data/{conversations,users,cache}
    
    # Set permissions
    chown -R "$SERVICE_USER:$SERVICE_USER" "$INSTALL_DIR"
    chmod -R 755 "$INSTALL_DIR"
    chmod -R 700 "$INSTALL_DIR"/{data,backups,sessions}
...
ProtectHome=true
ReadWritePaths=$INSTALL_DIR/data $INSTALL_DIR/logs $INSTALL_DIR/sessions
...
show_summary() {
    ...
    echo ""
    echo "🔐 Sécurité:"
    echo "   Pour appliquer les correctifs de sécurité:"
    echo "   cd $INSTALL_DIR"
    echo "   source venv/bin/activate"
    echo "   sudo -E ./apply_security_fixes_fixed.sh"
    echo ""
    echo "📚 Documentation: https://github.com/your-repo/llmui-core"
    echo ""
}
